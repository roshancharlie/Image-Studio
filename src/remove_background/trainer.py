...
def supervised_training_iter(
    ...
    Example:
        import torch
        from remove_background.models.modnet import MODNet
        from remove_background.trainer import supervised_training_iter
...
def soc_adaptation_iter(
    ...
    Example:
        ...
        import torch
        from remove_background.models.modnet import MODNet
        from remove_background.trainer import soc_adaptation_iter
    ...
    np_pred_fg = pred_fg.data_img.cpu().numpy()
